  ...
  <footer className="w-full max-w-[900px] mx-auto mt-16 pt-10 border-t border-[#e5e7eb] flex flex-col gap-8 pb-4">
    ...
    <div className="flex flex-col items-center gap-6 pt-8 mt-4 border-t border-[#f1f3f5]">
      ...
      <div className="flex flex-col items-center gap-3 w-full">
        <div className="text-[13px] text-[#6b7280] text-center flex flex-wrap justify-center items-center gap-x-1.5 gap-y-1">
          <span>Built & managed by</span>
          <a href="https://github.com/superezzdev/" target="_blank" rel="noreferrer" className="text-[#0a0908] font-bold hover:text-[#c4956a] transition-colors">- ARYA RCB</a>
        </div>
